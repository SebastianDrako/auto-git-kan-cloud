...
# Crear el archivo docker-compose.yml con Gitea y Nextcloud
...
http {
    ...
    server {
        ...
        client_max_body_size 1G; # Aumentado para subidas grandes a Nextcloud
...
log_info "El entorno base con Gitea y Nextcloud ha sido desplegado."
